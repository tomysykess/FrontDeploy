import {
  IProductForm,
  IProductFormErrorProps,
} from "@/components/productForm/types";
...
export function validateProductForm(
  ...
  if (!data.description) {
    ...
    errors.description =
      "La descripción debe tener más de 100 caracteres pero menos de 500.";
  }
  ...
  if (abv === undefined || data.abv === null) {
    ...
    errors.abv =
      "El ABV debe ser un número mayor que 0 y menor o igual a 99.99.";
  }
  ...
  if (size === undefined || size === null) {
    ...
    errors.size =
      "El tamaño debe ser un número mayor que 0 y menor o igual a 2000.";
  }
