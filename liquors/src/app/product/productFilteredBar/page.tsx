...
const ProductFiltered = () => {
  ...
  return (
    <>
      <div className=" pb-20 dark:bg-darkMode-greyVivino">
        <div className="flex flex-col  items-center">
          <button
            onClick={() => router.push("/product")}
            className=" p-2 mb-2 pb-2  bg-white rounded-[25px] border dark:bg-darkMode-grey2 dark:text-greyVivino border-gray-300 mt-2"
          >
            {" "}
            volver a buscar
          </button>
        ...
        <div className="flex relative flex-row pt-10 ">
          <div className="flex  mt-0 mb-96 bg-greyVivino dark:bg-darkMode-greyVivino ml-96">
