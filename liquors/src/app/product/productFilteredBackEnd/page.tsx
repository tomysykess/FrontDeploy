...
const ProductFilteredBackEnd = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-center w-full h-full bg-greyVivino">
        <div className="flex pt-4 flex-col items-center w-full">
          <button
            onClick={() => router.push("/product")}
            className="flex p-2  mb-2 pb-2 items-center rounded-[25px] border border-gray-300 mt-2 w-1/3 justify-center"
          >
            Volver a buscar
          </button>
