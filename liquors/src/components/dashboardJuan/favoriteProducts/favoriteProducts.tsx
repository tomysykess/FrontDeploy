...
export const FavoriteProductsCard = ({
  ...
  return (
    <div className="flex items-start max-w-2xl pr-72 border-r-8 font-plus-jakarta-sans border-r-wine shadow-lg  dark:bg-darkMode-greyVivino rounded-lg p-4 m-4 relative">
